...
public class CreateOpportunitiesWithClickOnSalesStageTest extends BaseClass {
	
	@Test
	public void createopportunitywithclickonsale() throws Throwable {
		...
		int randomInt= jLib.getRanDomNumber();
		 ...
		 String ClosingDate = eLib.getDataFromExcel("Orgsheet", 1, 4);
			...
			createopportunities.clickOnsalesStage();
			createopportunities.clickOnProspecting();
			System.out.println("Prospecting is selected seccessfully");
